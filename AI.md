...
- chipIconUnselect: `string` (optional) - Icon used for unselecting the chip. Displays a cross by default.
...
- optionIcon: `string` (optional) - Check icon. Displays a check by default.
